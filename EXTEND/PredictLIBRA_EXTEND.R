# ============================================================================ #
# File: PredictLIBRA_EXTEND.R
# Author: Jarno Koetsier
# Date: August 6, 2023
# Description: Predict LIBRA score in the EXTEND cohort.
# ============================================================================ #
...
save(Y_train, file = "EXTEND/Data/Y_train_LIBRA.RData")
...
# Load data
load("EXTEND/Data/Y_train_LIBRA.RData")
load("EXTEND/Data/methSet_allNorm_fil.RData")
...
save(selectedProbes, file = "Models/CAIDE_LIBRA/selectedProbes_LIBRA.RData")
...
# Load data
load("EXTEND/Data/Y_train_LIBRA.RData")
load("Models/CAIDE_LIBRA/selectedProbes_LIBRA.RData")
load("EXTEND/Data/methSet_allNorm_fil.RData")
...
# Save results
save(trainResults, predResults, file = "Models/CAIDE_LIBRA/LIBRA_OutputList_Cor_EN.RData")
...
# Save model
save(LIBRA_Model, file = "Models/CAIDE_LIBRA/LIBRA_Model_Cor_EN.RData")
...
# Save results
save(trainResults, predResults, file = "Models/CAIDE_LIBRA/LIBRA_OutputList_Cor_RF.RData")
...
# Select top correlated features for each factor
load("Models/CAIDE_LIBRA/correlations_LIBRA.RData")
probes <- list()
for (p in 1:ncol(correlations)){
  probes[[p]] <- names(tail(sort(abs(correlations[,p])),1100))
}
...
# Save model
save(LIBRA_Model, file = "Models/CAIDE_LIBRA/LIBRA_Model_Cor_RF.RData")
...
# Save model
save(LIBRA_Model, file = "Models/CAIDE_LIBRA/LIBRA_Model_None_EN.RData")
