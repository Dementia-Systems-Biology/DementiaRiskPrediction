...
# Save R objects
save(methSet_allNorm, file = "Data/methSet_allNorm_EXTEND.RData")
...
load("methSet_allNorm_EXTEND.RData")
...
save(lumi_dpval, file = "Data/lumi_dpval_EXTEND.RData")
...
densityNorm <- ggplot(plotDensity) +
  ...
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5,
                                  ...
                                  size = 16)) 
# Save plot
ggsave(densityNorm, file = "EXTEND/densityNorm.png", width = 8, height = 6)
...
densityRaw <- ggplot(plotDensity) +
  ...
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5,
                                  ...
                                  size = 16))
# Save plot
ggsave(densityRaw, file = "EXTEND/densityRaw.png", width = 8, height = 6)
