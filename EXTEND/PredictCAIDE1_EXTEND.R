...
save(Y_train, file = "EXTEND/Y_train_CAIDE1.RData")
...
# Load data
load("EXTEND/Y_train_CAIDE1.RData")
load("Data/methSet_allNorm_fil.RData")
...
# Load correlations with factors
load("EXTEND/correlations_factors.RData")

correlations_CAIDE1 <- correlations[, CAIDE1_factors]

# Selected probes
selectedProbes <- list()
for (i in 1:ncol(correlations_CAIDE1)){
  selectedProbes[[i]] <- names(tail(sort(abs(correlations_CAIDE1[,i])),10000))
}
names(selectedProbes) <- colnames(correlations)
save(selectedProbes, file = "EXTEND/selectedProbes_CAIDE1.RData")
...
# Save results
save(trainResults, predResults, file = "EXTEND/CAIDE1_OutputList_Cor_EN.RData")
...
# Save model
save(CAIDE1_Model, file = "EXTEND/CAIDE1_Model_Cor_EN.RData")
...
# Save results
save(trainResults, predResults, file = "EXTEND/CAIDE1_OutputList_Cor_RF.RData")
...
# Save model
save(CAIDE1_Model, file = "EXTEND/CAIDE1_Model_Cor_RF.RData")
...
# Save model
save(CAIDE1_Model, file = "EXTEND/CAIDE1_Model_Cor_None.RData")
